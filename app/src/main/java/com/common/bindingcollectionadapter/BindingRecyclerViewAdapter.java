...
//    @Override
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        Logger.v("111", "onAttachedToRecyclerView");
    }
...
//    @Override
    public void onDetachedFromRecyclerView(RecyclerView recyclerView) {
        ...
        Logger.v("111", "onDetachedFromRecyclerView");
    }
    ...
    public final ViewHolder onCreateViewHolder(ViewGroup viewGroup, int layoutId) {
        ...
        Logger.v("111", "onCreateViewHolder");
...
//        itemViewArg.select(position, items.get(position));
        if (position == items.size()) {
            itemViewArg.select(position, null);
        } else {
            itemViewArg.select(position, items.get(position));
        }
...
//            Utils.ensureChangeOnMainThread();
            for (int i = 0; i < itemCount; i++) {
                Logger.v("111","onItemRangeMoved="+i);
        ...
        public void onItemRangeRemoved(ObservableList sender, final int positionStart, final int itemCount) {
            ...
            Logger.v("111","onItemRangeRemoved");
//            Utils.ensureChangeOnMainThread();
