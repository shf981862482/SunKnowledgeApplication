...
import com.common.bindingcollectionadapter.factories.BindingAdapterViewFactory;
import com.common.bindingcollectionadapter.factories.BindingViewPagerAdapterFactory;
...
public class BindingCollectionAdapters {
    ...
    public static <T> void setAdapter(AdapterView adapterView, ItemViewArg<T> arg, List<T> items, BindingAdapterViewFactory factory, ItemView dropDownItemView, BindingListViewAdapter.ItemIds<T> itemIds) {
        if (null != items) {
            BindingListViewAdapter<T> adapter = null;
            if (adapterView.getAdapter() instanceof BindingListViewAdapter) {
                ...
                adapter = (BindingListViewAdapter<T>) headerViewListAdapter.getWrappedAdapter();
            }
            if (adapter == null) {
